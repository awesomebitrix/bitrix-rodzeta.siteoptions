...
Выберите в настройках модуля (вкладка Настройки) инфоблок в котором будет хранится дополнительные опции сайта (актуально для хранения значений html и изображений), при сохранении настроек - раздел создастся автоматически. Создайте список опций через интерфейс редактирования (вкладка Опции).
